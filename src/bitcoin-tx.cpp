...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s uraniumx-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  uraniumx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded UraniumX transaction") + "\n" +
              "  uraniumx-tx [options] -create [commands]   " + _("Create hex-encoded UraniumX transaction") + "\n" +
              "\n";
